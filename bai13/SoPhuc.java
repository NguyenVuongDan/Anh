...
public class SoPhuc {
	...
	SoPhuc thuong (SoPhuc sp1,SoPhuc sp2) {
		...
		thuong.pt=(float)giaihe(sp1.pt,sp1.pa,-sp1.pa,sp1.pt,sp2.pt,sp2.pa,1);
		thuong.pa=(float)giaihe(sp1.pt,sp1.pa,-sp1.pa,sp1.pt,sp2.pt,sp2.pa,2);
		return thuong;
	}
